...
chemprot_rel_scibert_model=chemprot_scibert_models/rel-chemprot-ctx0/
# pre-trained approximation relation model
scierc_rel_scibert_model_approx=chemprot_scibert_models/rel_approx-scib-ctx0/
...
# --context window 100 \
# --max_seq_length 512 \
# --entity_output_dir ${chemprot_ent_scibert_model}\
# --output_dir ${chemprot_rel_sciebert_model} 

#------end to end evaluation -----
python3 run_eval.py --prediction_file ${chemprot_rel_scibert_model}predictions.json
...
#  --max_seq_length 128 \
#  --entity_output_dir ${chemprot_ent_scibert_model} \
#  --output_dir ${chemprot_rel_scibert_model}
