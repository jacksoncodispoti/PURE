#!/bin/bash
#SBATCH -t 02:00:00   				#Time for the job to run 
...
#SBATCH -e results-xu/run_entity-%j.err
#SBATCH -o results-xu/run_entity-%j.out
...
time singularity exec --nv $container ./nlp-project-entity.sh
